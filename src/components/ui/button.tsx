...
const buttonVariants = cva(
  [
    ...
    "whitespace-nowrap rounded-sm transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&[disabled]]:pointer-events-none [&[disabled]]:opacity-50",
    "text font-medium uppercase",
    "z-0 after:absolute after:inset-0 after:-z-10 after:h-full after:w-full after:rounded-[inherit] after:border after:transition-all after:content-['']",
  ],
  {
    variants: {
      variant: {
      ...
      iconColor: {
        white: "text-primary-foreground/80",
        black: "text-secondary-foreground/80",
      },
    },
    defaultVariants: {
      variant: "default",
