...
export const Animation: FC<IProps> = async (props) => {
  ...
  return (
    <>
      <style>{getCustomGridPositionStyle(index, gridIndex, gridDesktopIndex)}</style>
      <VideoPlayer
        className={clsx("h-full w-full", "aspect-square outline outline-1 outline-neutral-500")}
