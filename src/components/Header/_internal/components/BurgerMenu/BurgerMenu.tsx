  ...
  return (
    <>
      ...
      <div
        ...
        } absolute flex flex-col items-center justify-center z-10 h-full md:h-auto w-full md:w-auto uppercase gap-6 md:gap-4 md:px-24 md:py-16 bg-black top-0 left-0 md:top-2 md:left-2 md:rounded-sm`}
      >
        <XMarkIcon
