    ...
    <>
      ...
      <CartButton
        ...
        className={clsx(
          ...
          cartOpen && "[&:hover+div]:!-translate-x-2",
        )}
        onClick={openCart}
      ...
      <div
        className={clsx(
          ...
          "translate-x-full bg-secondary/20 backdrop-blur transition-all md:rounded md:border md:border-border/20 md:shadow-lg",
          cartOpen && "-translate-x-2",
        )}
        ref={cartRef}
      >
