...
const LegalNoticePage: FC<IProps> = async (props) => {
  ...
  return (
    <div className='bg-white'>
      ...
      />
      <div
        className={clsx("mt-[64px] md:mt-[80px]", "min-h-screen px-6 py-4", "flex flex-col gap-4")}
      >
        <h1 className={clsx("text-xl font-bold uppercase")}>{dictionary.pages.legalNotice}</h1>
