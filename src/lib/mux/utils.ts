...
// !!! This might be removed when @mux/blurhash library (pb with sharp) is working along Next.js !!!
...
export const muxBlurHash = async (
  playbackId: string,
  ...
  if (
    ...
    typeof options.thumbnailToken !== "undefined"
  ) {
    if (
      typeof options.time !== "undefined" &&
      typeof options.thumbnailToken !== "undefined"
